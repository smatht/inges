...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Factura_emitida.subtotal'
        db.delete_column(u'facturacion_factura_emitida', 'subtotal')

        # Adding field 'Factura_emitida.total'
        db.add_column(u'facturacion_factura_emitida', 'total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Factura_emitida.subtotal'
        db.add_column(u'facturacion_factura_emitida', 'subtotal',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Factura_emitida.total'
        db.delete_column(u'facturacion_factura_emitida', 'total')
